# -*- coding: utf-8 -*-
"""
Normaliza el listado de socios exportado desde TRYLOGYC para el sector Internet.

Uso:
    python sectors/internet/normalizar.py [ruta_csv] [ruta_salida_csv]
...
CARPETA_SOCIOS = ROOT / "data" / "internet" / "socios"
SALIDA_DEFAULT = CARPETA_SOCIOS / "socios_normalizados.csv"


def normalizar(ruta_csv, ruta_salida=SALIDA_DEFAULT):
    """
    Normaliza un CSV de socios desde TRYLOGYC para el sector Internet.
