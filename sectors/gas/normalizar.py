# -*- coding: utf-8 -*-
"""
Normaliza el listado de socios exportado desde TRYLOGYC para el sector Gas.

Uso:
    python sectors/gas/normalizar.py [ruta_csv] [ruta_salida_csv]
